        ...
        <div className="withdrawal-box">
          ...
          <div className="withdrawal-warning-block">
            <div className="withdrawal-warning-main">
              <span className="withdrawal-warning-ask">
                정말 탈퇴하시겠어요?{' '}
                <span className="withdrawal-emoji">🥺</span>
              </span>
              <div className="withdrawal-warning-desc">
                <strong>
                  탈퇴 처리 전{' '}
                  <span className="withdrawal-warning-must">반드시</span> 확인해
                  주세요.
                </strong>
              </div>
            </div>
            <ul className="withdrawal-warning-list">
              <li>
                탈퇴와 함께 회원님의 모든 개인정보 및 서비스 이용 기록이{' '}
                <span className="withdrawal-warning-red">즉시 삭제</span>되며,
              </li>
              <li>
                삭제된 정보는{' '}
                <span className="withdrawal-warning-red">복구가 불가능</span>
                합니다.
              </li>
              <li>
                작성하신 게시글, 댓글 등 일부 콘텐츠는 탈퇴 이후에도{' '}
                <span className="withdrawal-warning-red">
                  삭제되지 않을 수 있습니다.
                </span>
              </li>
              <li>
                추후 동일한 이메일(ID)로 재가입하셔도{' '}
                <span className="withdrawal-warning-red">
                  기존 정보는 복구되지 않습니다.
                </span>
              </li>
          ...
          <form className="withdrawal-form">
            <div className="withdrawal-reason-title">
              탈퇴 사유를 선택해 주세요
            </div>
            <div className="withdrawal-reason-list">
              {reasons.map((r) => (
                <label
                  key={r}
                  className={`withdrawal-reason-option${reason === r ? ' selected' : ''}`}
                >
                  <input
                    type="radio"
            ...
            <div className="withdrawal-agree-block">
              <label className="withdrawal-agree-label">
                ...
                />
                <span>
                  위 내용을 모두 확인하였으며, 탈퇴 후 모든 정보가 삭제되는 것에
                  동의합니다.
                </span>
              </label>
            </div>
            <div className="withdrawal-password-block">
              <label className="withdrawal-password-label">
                현재 비밀번호 입력
              </label>
              <input
